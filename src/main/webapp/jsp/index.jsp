    ...
    <div class="wasnav">
        <div class="wasnav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a href="scooter.html" class="" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <li><a href="model.html" class="" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <li><a href="paymentmethod.html" class="" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <li><a href="subscription.html" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a href="rental.html" class="" aria-expanded="false">
                    <div class="menu-icon">
                ...
                <li><a href="scooterrack.html" class="" aria-expanded="false">
                    <div class="menu-icon">
    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">Empty</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Empty Page</a></li>
            </ol>
        </div>
    </div>
